...
const WatchPage = () => {
  ...
  // Manage current trailer index using cookies
  useEffect(() => {
    const savedIndex = Cookies.get("currentTrailerIdx");
    if (savedIndex !== undefined) {
      setCurrentTrailerIdx(parseInt(savedIndex, 10));
    }
  }, []);

  useEffect(() => {
    Cookies.set("currentTrailerIdx", currentTrailerIdx, { sameSite: "Strict" });
  }, [currentTrailerIdx]);
          ...
          content.map((item) => (
            ...
            >
              <div className='mb-4 md:mb-0'>
                ...
                <p className='mt-4 text-lg'>{item?.overview}</p>
              </div>
              <img
            ...
            >
              ...
              <ChevronLeft
                className='absolute top-1/2 -translate-y-1/2 left-2 w-8 h-8 opacity-0 
								group-hover:opacity-100 transition-all duration-300 cursor-pointer bg-black/50 hover:bg-black/70 
